$(document).ready(function () {
                        ...
                        required:'Ingrese Producto_update',
                    },descripcion_update: {
                        required:'Ingrese Descripcion_update',
                    },precio_update: {
                        required:'Ingrese Precio_update',
                    },stock_update: {
                        required:'Ingrese Stock_update',
                    },
                            },
                            honkeyup: false,
                    ...
                    );$('#tb_producto_create').validate(
                        {
                            ...
                            {
                                producto_create: {
                        required:'Ingrese Producto_create',
                    },descripcion_create: {
                        required:'Ingrese Descripcion_create',
                    },precio_create: {
                        required:'Ingrese Precio_create',
                    },stock_create: {
                        required:'Ingrese Stock_create',
                    },
                            },
                            honkeyup: false,
                            submitHandler: function () {
                        ...
                        required:'Ingrese Producto_delete',
                    },descripcion_delete: {
                        required:'Ingrese Descripcion_delete',
                    },precio_delete: {
                        required:'Ingrese Precio_delete',
                    },stock_delete: {
                        required:'Ingrese Stock_delete',
                    },
                            },
                            honkeyup: false,
                            submitHandler: function () {
            ...
            array.forEach(element => {
                ...
                $(nameselect).append(o);
                    ...
                    $('#id_producto_update').val(d[0]['id_producto']);$('#producto_update').val(d[0]['producto']);$('#descripcion_update').val(d[0]['descripcion']);$('#precio_update').val(d[0]['precio']);$('#stock_update').val(d[0]['stock']);
                    $('#modal_update').modal();
                }
                ...
                function seleccionarSelect(nameselect, valor) {
                    ...
                    var datos = {
                        id_producto: $('#id_producto_update').val(),producto: $('#producto_update').val(),descripcion: $('#descripcion_update').val(),precio: $('#precio_update').val(),stock: $('#stock_update').val()
                    };
                    ...
                    var datos = {
                        producto: $('#producto_create').val(),descripcion: $('#descripcion_create').val(),precio: $('#precio_create').val(),stock: $('#stock_create').val()
                    };
                ...
                var idDel = 0;function setMensajeModal(d) {
                    $('#id_producto_delete').val(d[0]['id_producto']);$('#producto_delete').val(d[0]['producto']);$('#descripcion_delete').val(d[0]['descripcion']);$('#precio_delete').val(d[0]['precio']);$('#stock_delete').val(d[0]['stock']);
                    $('#modal_delete').modal();
                    idDel = d[0]['id_producto'];
